...
public class MusicPublisherDatabase {
    ...
    public void addBandMember(long id_zesp, long id_art) {
    ...
    public void deleteBandMember(long id_zesp, long id_art) {
    ...
    public void addAuthor(String imie, String nazwisko, String pseudonim) {
    ...
    public void addAuthor(String nazwa, Vector<AuthorContainer> czlonkowie) {
    ...
    public void editAuthor(long id, String imie, String nazwisko, String pseudonim) {
    ...
    public void editAuthor(long id, String nazwa) {
    ...
    public void addAlbum(long id, String nazwa, String gatunek, Vector<SongContainer> songs) {
    ...
    public void deleteSong(long id_albumu, String nazwa) {
    ...
    public void addSong(long id_albumu, SongContainer song) {
    ...
    public void editAlbum(long id_albumu, String nazwa, String gatunek) {
    ...
    public void addEmployee(String imie, String nazwisko, String etat) {
    ...
    public void editEmployee(long id, String imie, String nazwisko, String etat, String old_etat){
    ...
    public void addBill(long id_prac, Date data_rozp, Date data_zak, double kwota) {
    ...
    public void editBill(long id_rachunku, Date data_rozp, Date data_zak, double kwota) {
    ...
    public void addContract(long id_autora, long id_menedzera, Date data_rozp, Date data_zak, double kwota) {
    ...
    public void editContract(long id_kontraktu, Date data_zawarcia, Date data_wygasniecia, double kwota) {
    ...
    public void addConcert(Date data, String kraj, String miasto, String ulica, double zysk) {
    ...
    public void addConcert(Date data, String kraj, String miasto, String ulica) {
        try(PreparedStatement stmt = conn.prepareStatement("INSERT INTO inf141302.Koncert(data_koncertu, kraj, miasto, ulica, zysk) VALUES (?, ?, ?, ?, ?)");) {
            stmt.setDate(1, data);
            stmt.setString(2, kraj);
            stmt.setString(3, miasto);
    ...
    public void editConcert(long id, Date data, String kraj, String miasto, String ulica, double zysk) {
    ...
    public void addConPerformer(long id_artysty, long id_koncertu) {
    ...
    public void deleteConPerformer(long id_artysty, long id_koncertu) {
    ...
    public void addTour(String nazwa, Date data_rozp, Date data_zak, Vector<Long> vcc) {
    ...
    public void addConToTour(long id_trasy, long id_koncertu) {
    ...
    public void deleteConFromTour(long id_koncertu) {
    ...
    public void editTour(long id_trasy, String nazwa, Date data_rozp, Date data_zak) {
    ...
    public void addStudio(String kraj, String miasto, String ulica) {
    ...
    public void editStudio(long id, String kraj, String miasto, String ulica) {
    ...
    public void addSession(long id_autora, Date data_sesji, long id_studia) {
    ...
    public void editSession(long new_id_autora, long old_id_autora, Date data_sesji, Date old_data_sesji, long new_id_studia) {
    ...
    public void addConTech(long id_koncertu, long id_prac) {
    ...
    public void deleteConTech(long id_koncertu, long id_prac) {
    ...
    public void addSesTech(long id_prac, Date data_sesji, long id_autora) {
    ...
    public void deleteSesTech(long id_prac, Date data_sesji, long id_autora) {
